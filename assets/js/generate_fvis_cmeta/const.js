...
const FVIS_CAR_DISTANCE_MIN = 50; // distance between cars(m)
const FVIS_CAR_DISTANCE_MAX = 100; // distance between cars(m)
const CAB64 = '2-20-9-0-101-9';

/** Const for Camera 10 ****************/
const TOTAL_WIDTH = 500;
const BRIDGE_OFFSET = 70;
const ROAD_OFFSET =10;
const BRIDGE_HEIGHT1 = 20;
const BRIDGE_HEIGHT2 = 15;
/***************************************/
